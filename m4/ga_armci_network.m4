...
AS_CASE([$ga_armci_network], [ARMCI], [], [AC_DEFINE([HAVE_ARMCI_STRIDE_INFO_INIT], [1], [])])
AM_CONDITIONAL([HAVE_ARMCI_STRIDE_INFO_INIT], [test "x$ga_armci_network" != xARMCI])
